...
void createTask() {
    cout << "\n========== CREATE TASK ==========\n";
    string title, desc, dueDate, category;
    ...
    if (title.empty()) {
        cout << "Sorry, title cannot be empty.\n";
        pauseForReturn();
        return;
    }
    ...
    if (category.empty()) {
        cout << "Sorry, category cannot be empty.\n";
        pauseForReturn();
        return;
    }
    ...
    while (!validPriority) {
        ...
        if (priority < 1 || priority > 5) {
            cout << "Sorry, please enter a number between 1 and 5.\n";
        } else {
            validPriority = true;
        }
    }
...
void viewTasks() {
    ...
    // FIRST: Ask about sorting
    cout << "\nWould you like to sort the tasks? (y/n): ";
    char sortChoice;
    cin >> sortChoice;
    cin.ignore();
    ...
    // SECOND: Display tasks and ask to view details
    cout << "\n========== VIEW TASKS ==========\n";
    cout << left
         << setw(4) << "ID" << "|"
         << setw(21) << "Title" << "|"
    ...
    try {
        ...
        cout << "Sorry, please enter a valid task ID.\n";
        pauseForReturn();
        return;
    }
...
void editTask() {
    ...
    if (choice < 1 || choice > 7) {
        cout << "Sorry, please enter a number between 1 and 7.\n";
        cout << "Press Enter to return to Main Menu.\n";
        cin.get();
        return;
    }
    ...
    if (choice == 1) {
        ...
        while (!validTime) {
            ...
            cin.ignore();
            if (newTime < 0) {
                cout << "Sorry, please enter a positive number for time.\n";
            } else {
